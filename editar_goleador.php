<?php
 ...
 $id = $_GET['id'];
 $goleador = $goleador->traerPorPK($id);
// var_dump($goleador);
...
<div id="container">    
    ...
    <?php
        ...
        ?>
        <h2 class="text-center pt-4">Editar goleador</h2>
        <?php
            
        ?>
        <form class="mb-4" action="acciones/editar_goleador.php" method="post">
            <div class="form-group col-10">
                <input type="hidden" value="<?= $goleador->getId();?>" name="id">
                <label for="nombre">Nombre</label>
                <input type="text" id="nombre" name="nombre" value="<?= $goleador->getNombre();?>" class="form-control">
            </div>
            <div class="form-group col-10">
                <label for="partidos">Partidos</label>
                <input type="text" id="partidos" name="partidos" value="<?= $goleador->getPartidos();?>" class="form-control">
            </div>
            <div class="form-group col-10">
                <label for="goles">Goles</label>
                <input type="text" id="goles" name="goles" value="<?= $goleador->getGoles();?>" class="form-control">
            </div>
            <div class="form-group col-10">
            ...
            <div class="form-group col-10">
                ...
                <input type="text" id="debut" name="debut" value="<?= $goleador->getDebut();?>" class="form-control">
            </div>
            <div class="form-group col-10">
                <label for="retiro">Año de retiro </label>
                <input type="text" id="retiro" name="retiro" value="<?= $goleador->getRetiro();?>" class="form-control">
            </div>
            <div class="col-10">
                <button class="btn btn-primary btn-block" type="submit">Terminar edición</button>
            </div>    
        </form>
        <?php
